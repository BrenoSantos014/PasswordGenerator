...
public class PasswordGeneratorGUI extends JFrame {
    ...
    private void addGUIComponents() {
        ...
        JTextField usernameLengthInputArea = new JTextField();
        ...
        JToggleButton saveToggle = new JToggleButton("save");
        saveToggle.setFont(new Font("Dialog", Font.PLAIN, 26));
        saveToggle.setBounds(25, 560, 200, 41);
        saveToggle.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                // código executado ao clicar
                String fieldName = usernameLengthInputArea.getText();
                String password = passwordOutput.getText();

                Account acco = new Account();
                acco.insert(fieldName, password);
            }
        });
        add(saveToggle);
        ...
        generateButton.setBounds(308, 560, 200, 41);
